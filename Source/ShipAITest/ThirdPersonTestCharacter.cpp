...
void AThirdPersonTestCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAction("Jump3rd", IE_Pressed, this, &ACharacter::Jump);
	PlayerInputComponent->BindAction("Jump3rd", IE_Released, this, &ACharacter::StopJumping);

	PlayerInputComponent->BindAxis("MoveForward3rd", this, &AThirdPersonTestCharacter::MoveForward);
	PlayerInputComponent->BindAxis("MoveRight3rd", this, &AThirdPersonTestCharacter::MoveRight);

	// We have 2 versions of the rotation bindings to handle different kinds of devices differently
	// "turn" handles devices that provide an absolute delta, such as a mouse.
	// "turnrate" is for devices that we choose to treat as a rate of change, such as an analog joystick
	PlayerInputComponent->BindAxis("Turn3rd", this, &APawn::AddControllerYawInput);
	PlayerInputComponent->BindAxis("TurnRate3rd", this, &AThirdPersonTestCharacter::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp3rd", this, &APawn::AddControllerPitchInput);
	PlayerInputComponent->BindAxis("LookUpRate3rd", this, &AThirdPersonTestCharacter::LookUpAtRate);
	...
	PlayerInputComponent->BindAction("ResetVR3rd", IE_Pressed, this, &AThirdPersonTestCharacter::OnResetVR);
}
